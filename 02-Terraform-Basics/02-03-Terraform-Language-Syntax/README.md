...
- Discuss about Terraform Top-Level blocks
  - Terraform Settings Block:   Fundamental Block
  - Provider Block:             Fundamental Block
  - Resource Block:             Fundamental Block

  - Input Variables Block:      Variable Block
  - Output Values Block:        Variable Block
  - Local Values Block:         Variable Block

  - Data Sources Block:         Calling/Referencing Block
  - Modules Block:              Calling/Referencing Block
