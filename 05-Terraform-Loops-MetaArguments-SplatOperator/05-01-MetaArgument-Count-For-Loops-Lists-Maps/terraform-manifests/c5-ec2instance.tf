...
resource "aws_instance" "myec2vm" {
  ...
  /*
  We have defined list and map variables in the c2-variables section.  We can then use them
  to specify values in later sections. 
  Here I have chosen the "qa" element from the variable var.instance_type_map
  The value of "qa" element is t3.small, so a t3.small resource will be created 
  */
  ...
  count = 2
  tags = {
    # Remember, count.index starts at 0
